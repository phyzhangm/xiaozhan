...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '20e4466cd18040008f51ab9d84a61d7e',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的知识分享者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.mwuli.top', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/3461580199037494', // B站主页
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,facebook,twitter,line,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9534592121', // 对应歌单的 id
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'f9f98c7d-7e44-44df-a3f0-a6814ddb9e6b', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
